    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5" key="step3">
      ...
      <div className="md:col-span-2">
        <Textarea
          ...
          placeholder="Describe the company, the transaction, the strategic rationale, and any key credit considerations we should understand before preparing your assessment..."
          rows={6}
        />
      </div>
    </div>,
      ...
      <div className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="text-center max-w-md animate-fade-in-up">
          ...
          <div className="flex gap-3 justify-center">
            ...
            <Link to="/upload" className="border border-navy-700 text-slate-300 hover:text-white text-sm px-6 py-3 rounded transition-all">
              Upload Documents
            </Link>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          {step < steps.length - 1 ? (
            <button
              ...
              className="flex items-center gap-2 bg-gold-400 hover:bg-gold-300 text-navy-950 font-semibold text-sm px-6 py-2.5 rounded transition-all"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-gold-400 hover:bg-gold-300 text-navy-950 font-semibold text-sm px-6 py-2.5 rounded transition-all shadow-lg shadow-gold-400/20"
            >
